...
export const metadata = {
  title: "Vidhya Tyres | Guide | Complete Guide to Tyre Maintenance",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vidhya Tyres Complete Tyre Maintenance Guide",
      },
    ],
    type: "website",
  },
  ...
  canonical: "https://vidhyatyres.in/guide/1",
};

export default function Guide1PageRoute() {
  return <Guide1Page />;
}
