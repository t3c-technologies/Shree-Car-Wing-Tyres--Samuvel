    ...
    <div className="min-h-screen bg-muted/20">
      ...
      <section className="relative py-16 md:py-24 bg-primary overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0 bg-[url('https://picsum.photos/1920/1080?random=100')] bg-cover bg-center"></div>
        </div>
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="text-center text-primary-foreground space-y-4 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 animate-fadeIn delay-300">
              <Link href="/tyres">
                <button className="bg-primary-foreground text-primary px-8 py-3 rounded-lg hover:bg-primary-foreground/90 transition-colors duration-300 inline-flex items-center font-semibold">
                  <AppIcon icon="mdi:view-grid" className="w-5 h-5 mr-2" />
                  Browse All Tyres
                </button>
              </Link>
              <a href={`tel:${CONTACT_INFO.phone}`}>
                <button className="border-2 border-primary-foreground text-primary-foreground px-8 py-3 rounded-lg hover:bg-primary-foreground hover:text-primary transition-colors duration-300 inline-flex items-center font-semibold">
