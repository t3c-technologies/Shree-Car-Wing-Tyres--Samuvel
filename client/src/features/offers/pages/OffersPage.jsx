                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {loading
                            ...
                            : offers.map((offer, index) => (
                                <div
                                    key={index}
                                    className={`group relative bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 animate-slideUp ${!offer.valid ? "opacity-50 grayscale pointer-events-none" : ""
                                        }`}
                                ...
                                >
                                    <div className="aspect-[4/3] relative overflow-hidden">
                                        ...
                                        />
                                        {offer.tag && (
                                            <span className="absolute top-4 right-4 bg-primary text-primary-foreground px-3 py-1 text-sm font-medium rounded-full">
                                                {offer.tag}
                                            </span>
                                        )}
                                    </div>
                                    <div className="p-6">
                                        <h3 className="text-xl font-bold text-card-foreground mb-2">{offer.title}</h3>
                    ...
                    <div className="mt-16 max-w-2xl mx-auto text-center space-y-8">
                        <div className="bg-green-500/10 p-6 rounded-xl">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-300 hover:scale-105 group"
                            >
                                <svg
                                    viewBox="0 0 24 24"
                                    className="w-5 h-5"
